...
import { makeBuscarEstoqueController } from "../factories/controllers/buscar-estoque";
...
export default (channel: any): void => {
    ...
    channel.consume('buscar-estoque', adaptQueue(channel, makeBuscarEstoqueController()));
}